...
--
-- Database: `pbp_variasi1`
--
DROP DATABASE IF EXISTS `pbp_variasi1`;
CREATE DATABASE IF NOT EXISTS `pbp_variasi1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `pbp_variasi1`;
